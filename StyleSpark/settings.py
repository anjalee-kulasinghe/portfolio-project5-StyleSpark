"""
Django settings for StyleSpark project.
...
SECRET_KEY = 'django-insecure-$^pc4vz(bs@axk7wlv5vtrvq*%7efaz@sufz5dheb%8+3_^zj9'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
    'project5-stylespark.herokuapp.com',
    'localhost',
    '127.0.0.1',
...
WSGI_APPLICATION = 'StyleSpark.wsgi.application'
